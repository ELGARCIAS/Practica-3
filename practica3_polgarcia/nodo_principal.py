...
from practica3_polgarcia.publisher_member_function import MinimalPublisher
from practica3_polgarcia.subscriber_member_function import MinimalSubscriber

class Nodoprincipal(Node):
    def __init__(self, x = 0, y = 0):
        super().__init__('nodo_principal')
